    ...
    <section class="section">
                ...
                <form class="row g-3" method="GET">
                    ...
                    <div class="d-flex justify-content-end gap-3 mt-3">
                        ...
                        <a href="{{ route('role.index') }}" class="btn btn-light" data-bs-toggle="tooltip"
                            data-bs-placement="top" title="Show All Role Data">
        ...
        <div class="card">
            ...
            <div class="card-header d-flex align-items-center justify-content-between"><span class="h4">Role List</span>
                <a href="{{ route('role.create') }}" class="btn btn-primary" data-bs-toggle="tooltip"
                    data-bs-placement="top" title="Add Role">
